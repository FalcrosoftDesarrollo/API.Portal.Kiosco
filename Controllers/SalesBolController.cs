...
namespace APIPortalKiosco.Controllers
{
    ...
    [ApiController]
    public class SalesBolController : Controller
    {
        #region CONSTRUCTOR
        /// <summary>
        ...
        [HttpGet]
        [Route("ProcesoSCOGRU")]
        public ActionResult Room(string pr_keypel, string pr_fecprg, string pr_horprg, string pr_tarprg, string pr_salprg, string pr_nompel, string pr_nomfec, string pr_nomhor, string pr_nomtar, string pr_cenprg, string pr_imgpel)
        {
            #region VARIABLES LOCALES
            int lc_maxcol = 0;
            int lc_maxfil = 0;
        ...
        public ActionResult Onboarding(string pr_keypel, string pr_fecprg, string pr_horprg, string pr_tarprg, string pr_salprg, string pr_nompel, string pr_nomfec, string pr_nomhor, string pr_nomtar, string pr_cenprg, string pr_secsec, string pr_selubi, string pr_flggaf = "")
        {
            #region VARIABLES LOCALES
            int lc_idearr = 0;
            double lc_valtar = 0;
        ...
        public ActionResult PreOnboarding(string pr_keypel, string pr_fecprg, string pr_horprg, string pr_tarprg, string pr_salprg, string pr_nompel, string pr_nomfec, string pr_nomhor, string pr_nomtar, string pr_cenprg, string pr_secsec, string pr_selubi, string pr_flag3d)
        {
            #region VARIABLES LOCALES
            string lc_result = string.Empty;
            string lc_srvpar = string.Empty;
            ...
            try
            {
                ...
                ob_datpro.Codigo = 379;
                ob_datpro.SwtVenta = "V";
                ob_datpro.TipoCompra = "B";
        ...
        public ActionResult Room(BolVenta pr_bolvta)
        {
            #region VARIABLES LOCALES
            int lc_idearr = 0;
            double lc_valtar = 0;
        ...
        public ActionResult PreOnboarding(Producto pr_datpro, string pr_keypel, string pr_fecprg, string pr_horprg, string pr_tarprg, string pr_salprg, string pr_nompel, string pr_nomfec, string pr_nomhor, string pr_nomtar, string pr_cenprg, string pr_secsec, string pr_selubi, string pr_flag3d)
        {
            try
            {
                URLPortal(config);
